...
## 🧠 Features
- Input multiple skills  
- Classifies them as Hard or Soft  
- Prints inspiring messages for each  
- Simple, elegant, and beginner-friendly Java logic  

---

## 🛠️ Tools Used
- Java (JDK 8 or later)
- Any IDE (VS Code, IntelliJ, or Eclipse)

---

## ▶️ How to Run
1. Save the file as `SkillCraft.java`  
2. Compile it:
   ```bash
   javac SkillCraft.java
